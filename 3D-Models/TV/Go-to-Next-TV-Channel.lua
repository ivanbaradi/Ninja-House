...
--Prompts user to go to the next channel
ProximityPrompt.Triggered:Connect(function(player)
	...
	--Changes the channel
	if ChannelNumber.Value < #TV_Channels_VIDEO then
	...
	TV:FindFirstChild('Previous Button').ProximityPrompt.ObjectText = ChannelName
end)